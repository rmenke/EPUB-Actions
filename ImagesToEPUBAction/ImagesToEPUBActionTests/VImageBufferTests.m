...
- (void)testHough {
    ...
    NSArray<NSArray<NSNumber *> *> *lines = [buffer findSegments:@{@"grayThreshold":@0x7f, @"channelWidth":@3, @"maxSegmentGap":@4, @"minSegmentLength":@5, @"significance":@1E-4} error:&error];
...
- (void)testHoughWithImage01 {
    ...
    [self measureMetrics:XCTestCase.defaultPerformanceMetrics automaticallyStartMeasuring:NO forBlock:^{
        ...
        [self startMeasuring];
        segments = [buffer findSegments:@{@"grayThreshold":@0x7f, @"channelWidth":@3, @"maxSegmentGap":@4, @"minSegmentLength":@5, @"significance":@1E-15} error:&error];
        [self stopMeasuring];
...
- (void)testHoughWithAdditionalImages {
    ...
    for (NSURL *url in files) {
        ...
        NSArray<NSArray<NSNumber *> *> *segments = [buffer findSegments:@{@"signficance":@1E-15} error:&error];
